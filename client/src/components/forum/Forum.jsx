    ...
    <div className="forum-content w-full">
      <div className="container mx-auto">
        <div className="py-32 flex justify-center items-center w-full">
          <div className="bg-[#001313] flex flex-col justify-center items-center shadow-sm shadow-blue-300 md:px-8 rounded-2xl md:py-8 hover:shadow-blue-300 p-4 w-full">

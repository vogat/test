...
const courseDetailsData = {
  1: {
    ...
    tutor_bio: "John Doe is a seasoned Kafka expert...",
  ...
  2: {
    ...
    tutor_bio: "Jane Smith is a leading React developer...",
  ...
  3: {
    ...
    tutor_bio: "Mike Johnson has over 10 years of Terraform experience...",
  ...
  4: {
    ...
    tutor_bio: "Emily Davis has built numerous full stack applications...",
  ...
  5: {
    ...
    tutor_bio: "Chris Wilson is a AWS guru...",
